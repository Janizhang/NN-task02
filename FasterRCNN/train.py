...
parser.add_option('--cuda', dest='mps', help='Whether to use GPU or not.', default=True)
...
root = '/Users/ynzhang/Downloads/MIDTERM/FasterRCNN'
...
if Cuda:
	...
	model_train = model_train.to('mps')
